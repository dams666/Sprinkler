...
void simple_setup_6_buttons(LCD * lcd_, byte columns, byte rows, byte btn_u, byte btn_d, byte btn_l, byte btn_r, byte btn_b, byte btn_a); ///< Sets up the library with lcd object and 6 buttons
void simple_setup_phi_2(LCD * lcd_, byte columns=20,byte rows=4);    ///< Set up the library for phi-2 shield, default 20X4
void simple_setup_phi_3(LCD * lcd_, byte columns=20,byte rows=4);    ///< Set up the library for phi-3 shield, default 20X4
