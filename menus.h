...
static const char* const CONFIG_MENU_ITEMS[] PROGMEM = {GEN_MENU_ITEMS_CHAN_1, GEN_MENU_ITEMS_CHAN_2, GEN_MENU_ITEMS_CHAN_3, GEN_MENU_ITEMS_CHAN_4, GEN_MENU_ITEMS_CHAN_5, GEN_MENU_ITEMS_CHAN_6, CONFIG_MENU_ITEMS_FACT, GEN_MENU_ITEMS_RETURN};
